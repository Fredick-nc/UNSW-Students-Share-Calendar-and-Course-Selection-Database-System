...
create or replace function check_q1_a() returns text
as $chk$
select ass2_check('view','q1_a','q1a_expected',
                   $$select * from q1_a$$)
$chk$ language sql;

create or replace function check_q1_b() returns text
as $chk$
select ass2_check('view','q1_b','q1b_expected',
                   $$select * from q1_b$$)
$chk$ language sql;
...
COPY q1a_expected (name, school, starting) FROM stdin;
...
COPY q1b_expected (status, name, school, starting) FROM stdin;
...
COPY q2_expected (subject_code, use_rate) FROM stdin;
CHEM1011	14
ECON1202	14
\.

COPY q3_expected (unsw_id, student_name) FROM stdin;
2272011	Dominic Barcz
2277008	Daniel De Hoop
2248083	Robert Torazzi
3072343	Dounia Zanich
3011341	Maria Satouris
3082284	Thomas Chiofalo
3033560	Hyeon Jinkyu
3096847	Boon Clements
3018301	Emily Madvig
3058360	Dean McGowan
3049718	Tharukshini Jinasena
3181492	Timothy De Paoli
3148679	Philip Bulbert
3156316	Abd-El-Mesih Bahwan
3155854	Leng Meng Tong Derek
\.
